...
public class Drift : MonoBehaviour {
    ...
    public float driftMaxAngle = 40f;
    public float driftAngleBuildSpeed = 5f;
    public float driftAngleReturnSpeed = 2f;
    public float maxDriftSpeed = 1.5f;
    public float driftSpeedBoost = 1.2f;
    public float driftSpeedDecay = 2.0f;
    ...
    void Update()
    {
        ...
        else
        {
            ...
            zVal = transform.eulerAngles.z + rotateDegreesPerSec * Time.deltaTime * -turnInput;
        }
        // Apply new rotation
        ...
        // Determine travel velocity. The car will interpolate towards the target drift angle.
